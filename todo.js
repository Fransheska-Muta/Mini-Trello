...
function addTaskEvents() {
    ...
    // this checks for when a p element is dragged over the zone(swimlane) the appends to it
    ...
    // this add the specific class when the P element is being dragged and removes it when its not, the saves to local storage
    document.querySelectorAll(".task").forEach((task) => {
        ...
        // this listens for when the span element with the specific class is clicked then performs its function
